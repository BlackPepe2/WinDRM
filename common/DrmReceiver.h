...
#define	NUM_FAC_FRA_U_ACQ_WITHOUT_S		9		//9*400ms = 3.6 sec
#define	NUM_FAC_FRA_U_ACQ_WITHOUT_F		4		//4*400ms = 1.6 sec
...
public:
	...
	void					SetFreqAcqSensivity(_REAL rNewSensivity)
							{FreqSyncAcq.SetSensivity(rNewSensivity); }
